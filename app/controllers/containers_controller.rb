class ContainersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @container.update(container_params)
        format.html { redirect_to @container, notice: "Container was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to containers_path, notice: "Container was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def container_params
      params.require(:container).permit(:code, :slot_id, :truck_id)
    end
end
