...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference("Container.count") do
      post containers_url, params: { container: { code: @container.code, slot_id: @container.slot_id, truck_id: @container.truck_id } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { code: @container.code, slot_id: @container.slot_id, truck_id: @container.truck_id } }
